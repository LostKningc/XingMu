package top.ashher.xingmu.service.pay.alipay;
...
import top.ashher.xingmu.enums.PayChannel;
...
import top.ashher.xingmu.service.pay.TradeResult;
import top.ashher.xingmu.service.pay.alipay.config.AlipayProperties;
...
public class AlipayStrategyHandler implements PayStrategyHandler {
    ...
    public PayResult pay(String outTradeNo, BigDecimal price, String subject, String notifyUrl, String returnUrl){
        try {
            ...
            throw new XingMuFrameException(BaseCode.PAY_ERROR);
        }
    }
    ...
    public RefundResult refund(String outTradeNo, BigDecimal price, String reason) {
        ...
        try {
            ...
            throw new XingMuFrameException(BaseCode.REFUND_ERROR);
        }
    }
    ...
    private Integer convertPayBillStatus(String tradeStatus){
        ...
        throw new XingMuFrameException(BaseCode.ALIPAY_TRADE_STATUS_NOT_EXIST);
    }
}
