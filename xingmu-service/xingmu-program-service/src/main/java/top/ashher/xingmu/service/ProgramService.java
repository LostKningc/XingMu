...
import top.ashher.xingmu.entity.*;
        ...
        switch (programPageListDto.getTimeType()) {
            ...
            case ProgramTimeType.CALENDAR:
                if (Objects.isNull(programPageListDto.getStartDateTime())) {
                    throw new XingMuFrameException(BaseCode.START_DATE_TIME_NOT_EXIST);
                }
                if (Objects.isNull(programPageListDto.getEndDateTime())) {
                    throw new XingMuFrameException(BaseCode.END_DATE_TIME_NOT_EXIST);
                }
                break;
            default:
