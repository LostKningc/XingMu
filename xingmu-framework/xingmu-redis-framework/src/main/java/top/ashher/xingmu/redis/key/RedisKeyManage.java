package top.ashher.xingmu.redis.key;
...
public enum RedisKeyManage {
    ...
    COUNTER_COUNT("counter_count","计数器的值的key","计数器的值","k"),

    COUNTER_TIMESTAMP("counter_timestamp","计数器的时间戳的key","计数器的时间戳","k"),

    VERIFY_CAPTCHA_ID("verify_captcha_id_%s","校验验证码id的key","校验验证码id","k"),
